  ...
  return (
    <main className="min-h-screen bg-[#1B0F40] text-white flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(138,43,226,0.3)_0%,_transparent_70%)]" />
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
      ...
      <div className="relative z-10 flex flex-col items-center mt-4">
        ...
        <h1 className="text-4xl font-black mt-4 drop-shadow-[0_4px_0_#000] text-transparent bg-clip-text bg-gradient-to-b from-purple-200 to-purple-500">
          Kios Tuan Hantu
        </h1>
      </div>
          ...
          {activeTab === "shop" ? (
            ...
            >
              {ACHIEVEMENTS.map((ach) => {
                ...
                return (
                  <div key={ach.id} className={`flex items-center gap-4 p-4 rounded-2xl border-2 transition-all ${isUnlocked ? 'bg-gradient-to-r from-yellow-900/50 to-amber-900/50 border-yellow-500/50 shadow-[0_0_20px_rgba(217,119,6,0.3)]' : 'bg-black/40 border-white/5 opacity-70'}`}>
