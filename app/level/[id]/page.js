      ...
      <header className="p-6 flex items-center gap-6 z-10">
        <button 
          ...
          className="
            ...
            bg-red-500 border-4 border-white border-b-[8px] border-b-red-700
        ...
        <div className="flex-1 h-10 bg-white/50 backdrop-blur-md rounded-full border-4 border-white shadow-[inset_0_4px_8px_rgba(0,0,0,0.1)] overflow-hidden relative">
          <div 
            className="absolute top-0 left-0 bottom-0 bg-gradient-to-r from-green-400 to-green-500 rounded-full transition-all duration-700 ease-out shadow-[inset_0_-4px_0_rgba(0,0,0,0.1)]"
