...
export function VideoIntroModal({ isOpen, onStart }) {
  ...
  return (
    <div className="fixed inset-0 z-200 flex flex-col items-center justify-center bg-black/95 backdrop-blur-md p-4">
      ...
      <div className="w-full max-w-3xl aspect-video bg-gray-800 rounded-4xl border-8 border-yellow-400 shadow-[0_0_50px_rgba(255,255,0,0.3)] overflow-hidden relative mb-8 shrink-0">
        <iframe
      ...
      <div className="relative z-20 flex justify-center">
        <button 
          ...
          className="
            ...
            border-b-12 border-b-green-700 
            shadow-[0_15px_30px_rgba(0,0,0,0.5),inset_0_6px_0_rgba(255,255,255,0.4)]
            active:border-b-4 active:translate-y-2 active:shadow-[0_5px_10px_rgba(0,0,0,0.5),inset_0_2px_0_rgba(255,255,255,0.4)]
