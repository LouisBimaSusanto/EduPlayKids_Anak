            ...
            return (
              ...
              >
                ...
                <div className="relative">
                  <span className="text-[6rem] md:text-6xl md:text-[8rem] drop-shadow-[0_10px_20px_rgba(0,0,0,0.5)]" style={{ display: 'inline-block', transform: i % 2 === 1 && !isCaught ? "scaleX(-1)" : "none" }}>🐟</span>
