          ...
          {!isSuccess ? (
            ...
            >
              ...
              >
                ...
                <span className="text-[6rem] md:text-6xl md:text-[8rem] drop-shadow-xl">{EMOJI_MAP[roundData.target[0]]}</span>
                <span className="text-[6rem] md:text-6xl md:text-[8rem] drop-shadow-xl">{EMOJI_MAP[roundData.target[1]]}</span>
              </motion.div>
            </motion.div>
          )}
        </AnimatePresence>
