    ...
    <>
      ...
      <div className="w-full flex-1 flex flex-row items-end justify-center relative pb-16 gap-12">
        ...
        <motion.div 
          ...
          className="text-7xl md:text-[14rem] drop-shadow-[0_20px_30px_rgba(0,0,0,0.6)] z-20"
        >
          🦊
        </motion.div>
        ...
        <div className="relative">
          ...
          <motion.div 
            ...
            className="text-7xl md:text-[16rem] drop-shadow-[0_20px_40px_rgba(0,229,200,0.6)] z-30"
          >
            🍲
          </motion.div>
          ...
          {!isSuccess && roundData.options.map((opt, i) => {
            ...
            return (
              <motion.button 
                ...
                `}
              >
                <span className="text-6xl md:text-[7rem] drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]">
                  {opt.emoji}
                </span>
              </motion.button>
            );
