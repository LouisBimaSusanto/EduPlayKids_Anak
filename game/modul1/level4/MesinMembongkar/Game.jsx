          ...
          {!isSuccess ? (
            ...
            >
              ...
              >
                ...
                {/* The Item inside */}
                <span className="text-[6rem] md:text-6xl md:text-[8rem] drop-shadow-xl opacity-90">{EMOJI_MAP[roundData.image]}</span>
            ...
            <motion.div
              ...
              className="relative z-20 mb-16 flex items-center justify-center"
            >
              <span className="text-6xl md:text-[8rem] md:text-7xl md:text-[10rem] drop-shadow-[0_0_50px_#fde047]">{EMOJI_MAP[roundData.image]}</span>
